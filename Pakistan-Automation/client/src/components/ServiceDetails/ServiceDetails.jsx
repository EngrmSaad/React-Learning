  ...
  const products = [
    {
      ...
      // ],
      boxDetails:
        "Unlock data-driven insights with our Power BI services. We transform your raw data into actionable visualizations for informed decision-making. Harness the power of data with us.",
    },
    {
      id: 1,
      productName: "Power Platforms",
      // iconRight: <i className="fas fa-chevron-right icon-right "></i>,
      // iconLeft: <i className="fas fa-chevron-left icon-left mt-2 "></i>,
      // productsList: [
      //   [
      ...
      // ],
      boxDetails:
        "Elevate your business with our Power Platform services. We build custom solutions, automate processes, and empower your team to do more with less. Transform your operations and drive efficiency with our expertise.",
    },

    {
      ...
      // ],
      boxDetails:
        "Empower your online presence with our expert web development services. We create stunning, functional websites tailored to your needs. Let us bring your digital vision to life.",
    },
    // {
    //   id: 4,
